...
if($rowmctdetailck==0){
  ?>
    ...
    <td><textarea rows="3" cols="10" name='macald<?php echo $row; ?>'></textarea></td> 
...
<tr id="rowat-de<?php echo $row; ?>">
    ...
    <td ><input type='radio' <?php  if($row_mctdetailck['PM_CM']=="PM") echo"checked" ; ?> name='Remark<?php echo $row; ?>'  value='PM'> PM<br><input type='radio' <?php  if($row_mctdetailck['PM_CM']=="CM") echo"checked" ; ?> name='Remark<?php echo $row; ?>'  value='CM'> CM<br><input type='radio' <?php  if($row_mctdetailck['PM_CM']=="") echo"checked" ; ?> name='Remark<?php echo $row; ?>'  value=''> ปกติ</td>
     <td><input type="text" size="8" name="machour<?php echo $row; ?>" value="<?php echo $row_mctdetailck['Mac_hour']; ?>"></td>
    <td ><textarea type='text' value="" name='mac-problem<?php echo $row; ?>'  rows="3" cols="40"><?php echo $row_mctdetailck['Description']; ?></textarea></td>
    ...
    <td><textarea rows="3" cols="17" name='macald<?php echo $row; ?>'><?php echo $row_mctdetailck['Remark']; ?></textarea></td> 
