...
<table width="1300" border="0"><tr ><td colspan = '8'><font style="color:#ff0000; font-size:22px;"><center>สรุปสถานการณ์เครื่องจักรหลัก ประจำวันที่ <?php $eng_date = strtotime($date); // แสดงวันที่ปัจจุบัน
echo thai_date($eng_date);?></center></font></td></tr></table>
