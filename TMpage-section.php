...
<input type="hidden" name="equipment_id<?php echo $row; ?>"  value="<?php echo $id; ?>">
  ...
  if($row_tmdetailck['finished_date']==""){
?>
<tr id="rowat-de<?php echo $row; ?>">
    ...
    <td ><input type='radio' <?php  if($row_tmdetailck['PM_CM']=="PM") echo"checked" ; ?> name='Remark<?php echo $row; ?>'  value='PM'> PM<br><input type='radio' <?php  if($row_tmdetailck['PM_CM']=="CM") echo"checked" ; ?> name='Remark<?php echo $row; ?>'  value='CM'> CM<br><input type='radio' <?php  if($row_tmdetailck['PM_CM']=="") echo"checked" ; ?> name='Remark<?php echo $row; ?>'  value=''> ปกติ</td>
     <td><input type="text" size="8" name="machour<?php echo $row; ?>" value="<?php echo $row_tmdetailck['Mac_hour']; ?>"></td>
    <td ><textarea type='text' value="" name='mac-problem<?php echo $row; ?>'  rows="3" cols="40"><?php echo $row_tmdetailck['Description']; ?></textarea></td>
    ...
    <td><textarea rows="3" cols="17" name='macald<?php echo $row; ?>'><?php echo $row_tmdetailck['Remark']; ?></textarea></td> 
